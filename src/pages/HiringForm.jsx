            ...
            <div className="w-full max-w-5xl mx-auto p-4 md:p-8 space-y-5 text-gray-800 mt-5 bg-white rounded-xl shadow-lg border border-gray-100">
                <div className="flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold text-teal-500">pitchlt</h1>
                    </div>
                ...
                <div className="relative w-full mb-10 pt-0 sm:pt-0">
                    ...
                    <div
                        className={`absolute top-0 h-3 bg-teal-500 rounded-full transition-all duration-500`}
...
                  ${+step === activeStep
                ...
                <form onSubmit={(e) => e.preventDefault()} className="space-y-10">
                    ...
                    <div
                        ref={personalRef}
                        className={`space-y-5 shadow-lg p-5 rounded-2xl border transition-all ${completedSections[1] ? "border-teal-400" : "border-gray-200"
                            }`}
                    >
                        <h2 className="text-xl font-semibold flex items-center gap-2">
                            <User size={20} className="text-teal-500" /> Personal Information
                            {completedSections[1] && (
                                <CheckCircle size={18} className="text-teal-500 ml-2" />
                            )}
                        </h2>
                    ...
                    <div
                        ref={positionRef}
                        className={`space-y-5 shadow-lg p-5 rounded-2xl border transition-all ${completedSections[2] ? "border-teal-400" : "border-gray-200"
                            }`}
                    >
                        <h2 className="text-xl font-semibold flex items-center gap-2">
                            <Briefcase size={20} className="text-teal-500" /> Position Details
                            {completedSections[2] && (
                                <CheckCircle size={18} className="text-teal-500 ml-2" />
                            )}
                        </h2>
                    ...
                    <div
                        ref={skillsRef}
                        className={`space-y-5 shadow-lg p-5 rounded-2xl border transition-all ${completedSections[3] ? "border-teal-400" : "border-gray-200"
                            }`}
                    >
                        <h2 className="text-xl font-semibold flex items-center gap-2">
                            <CheckCircle size={20} className="text-teal-500" /> Skills &
                            Experience
                            {completedSections[3] && (
                                <CheckCircle size={18} className="text-teal-500 ml-2" />
                            )}
                            ...
                            <div className="flex flex-wrap gap-3 mt-2">
                                {skillsList.map((skill) => (
                                    <span
                                        ...
                                        className={`px-4 py-2 shadow-sm rounded-full cursor-pointer text-sm transition-colors ${selectedSkills.includes(skill)
                        ...
                        <div>
                            ...
                            <div
                                ...
                                className="mt-2 border-2 border-dashed border-gray-400 p-6 rounded-lg text-center cursor-pointer hover:border-teal-500 transition-colors"
                            >
                                {formData.resumeFile ? (
                                    <p className="text-teal-500 font-medium text-sm sm:text-base">
                                ...
                                <button
                                    type="button"
                                    className="mt-3 px-4 py-2 bg-teal-500 text-white rounded-lg hover:bg-teal-600 text-sm sm:text-base"
                                >
                                    Browse File
                                </button>
                            </div>
                    ...
                    <div
                        ref={additionalRef}
                        className={`space-y-5 shadow-lg p-5 rounded-2xl border transition-all ${completedSections[4] ? "border-teal-400" : "border-gray-200"
                            }`}
                    >
                        <h2 className="text-xl font-semibold flex items-center gap-2">
                    ...
                    <div className="space-y-4 p-5">
                        ...
                        <div className="flex items-start gap-3 text-sm sm:text-base">
                            <input
                                ...
                                onChange={handleInputChange}
                                className="mt-1 w-5 h-5 accent-teal-500 border-gray-300 rounded focus:outline-none"
