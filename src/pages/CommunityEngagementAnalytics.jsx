...
//     <main className="min-h-screen bg-[#0B0F1A] text-gray-200 px-4 md:px-8 py-5 font-sans">
//       {/* Header */}
...
//           </h1>
//           <p className="text-sm text-gray-400 mt-1">Real-time performance metrics for your pitch deck</p>
//         </div>
...
//             <span className="absolute top-2 right-2 w-2 h-2 bg-violet-500 rounded-full border-2 border-[#151A2D]"></span>
//           </button>
//         </div>
//       </div>
...
//             <span className="text-xs font-medium uppercase tracking-wider">Top Slide</span>
//           </div>
//           <div>
//             <p className="mt-4 text-lg font-bold text-white">Slide 3: Problem</p>
//             <p className="text-xs text-gray-500 mt-1">Highest retention rate</p>
//           </div>
//         </div>
//       </div>
...
//           <h2 className="text-lg font-semibold text-white">Engagement Funnel</h2>
//           <p className="text-sm text-gray-400 mb-8">User progression through pitch stages</p>
...
//         <div className="bg-[#151A2D] rounded-2xl p-6 border border-white/5">
//           <h2 className="text-lg font-semibold text-white mb-6">Slide Engagement Heatmap</h2>
//           <div className="overflow-x-auto">
//             <div className="min-w-[400px]">
//               <div className="grid grid-cols-[1.5fr_1fr_1fr] gap-y-4 text-xs font-semibold uppercase tracking-widest text-gray-500 mb-4 px-2">
...
//                   <div key={i} className="grid grid-cols-[1.5fr_1fr_1fr] items-center bg-[#0B0F1A]/50 p-3 rounded-xl border border-white/5">
//                     <span className="text-sm font-medium text-gray-200 truncate">{slide.title}</span>
//                     <div className="flex justify-center">
//                       <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase ${slide.color}`}>
//                         {slide.level}
//                       </span>
//                     </div>
//                     <span className="text-right text-sm font-mono text-gray-400">{slide.time}</span>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//         {/* Audience Drop-off */}
//         <div className="bg-[#151A2D] rounded-2xl p-6 border border-white/5">
//           <h2 className="text-lg font-semibold text-white">Audience Drop-off Analysis</h2>
//           <p className="text-sm text-gray-400 mb-8">Identify where viewers lose interest</p>
...
//                 style={{ bottom: `${y}%` }}
//               >
//                 <span className="absolute -left-10 text-[10px] font-mono text-gray-500">{y}%</span>
//               </div>
//             ))}
...
//           <h2 className="text-lg font-semibold text-white mb-2">Key Insights</h2>
//           <p className="text-sm text-gray-400 mb-6">Actionable takeaways for your pitch</p>

//           <div className="flex-1 space-y-4">
//             <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/20">
//               <p className="text-sm leading-relaxed text-gray-200">
//                 Audience interest significantly drops after <span className="text-red-400 font-bold">slide 7 (Team)</span>. 
//                 Consider moving your "Ask" before this point.
//               </p>
//             </div>

//             <div className="p-4 rounded-xl bg-violet-500/10 border border-violet-500/20">
//               <p className="text-sm leading-relaxed text-gray-200">
//                 <span className="text-violet-400 font-bold block mb-1">Suggestion:</span> 
//                 The high engagement on Slide 3 suggests your "Problem Statement" is very relatable.
//               </p>
//             </div>
//           </div>
//         </div>
...
//   return (
//     <div className="bg-[#151A2D] rounded-2xl p-4 md:p-5 border border-white/5 hover:border-white/10 transition-all">
//       <div className="flex items-center gap-2 text-gray-400 mb-4">
//         <div className="p-1.5 rounded-lg bg-[#0B0F1A] text-violet-400 shrink-0">
//           {icon}
//         </div>
//         <span className="text-[10px] md:text-xs font-medium uppercase tracking-wider truncate">{title}</span>
//       </div>

//       <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-1">
//         <p className="text-xl md:text-2xl font-bold text-white tracking-tight">{value}</p>
//         <div className={`flex items-center gap-0.5 text-[10px] md:text-xs font-bold ${positive ? "text-emerald-400" : "text-rose-400"}`}>
...
//       <span className="w-24 md:w-32 text-xs font-medium text-gray-400 truncate">
//         {label}
//       </span>
//       <div className="flex-1">
//         <div
//           className="bg-gradient-to-r from-violet-600 to-violet-400 h-6 md:h-8 rounded-md transition-all duration-1000"
//           style={{ width }}
//         />
//       </div>
//       <span className="w-8 md:w-10 text-right text-[10px] font-mono text-gray-500">
//         {value}
//       </span>
//     </div>
//   );
